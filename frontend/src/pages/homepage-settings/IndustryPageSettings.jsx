...
const IndustryPageSettings = () => {
    ...
    const handleSave = async () => {
        setLoading(true);
        try {
            await API.put('/industry-page', settings);
                            ...
                            {settings.projects.map((proj, idx) => (
                                ...
                                <button onClick={() => handleRemoveFromArray('projects', idx)} className="absolute top-2 right-2 text-red-500 hover:bg-red-50 p-1 rounded"><Trash2 size={18}/></button>
                                    ...
                                    <div className="flex gap-2">
                                        ...
                                        <button onClick={() => openMediaPicker((url) => handleArrayChange('projects', idx, 'image', url))} className="bg-white px-3 border rounded text-sm"><Image size={16}/></button>
                                    </div>
                    ...
                    {activeTab === 'leaders' && (
                        ...
                        <div className="space-y-4">
                            {settings.trustedLogos.map((logo, idx) => (
                                <div key={idx} className="bg-slate-50 p-4 rounded-lg border relative flex gap-3 items-center">
                                    ...
                                    })} className="bg-white px-3 py-2 border rounded text-sm"><Image size={16}/></button>
                                    <button onClick={() => handleRemoveFromArray('trustedLogos', idx)} className="text-red-500 hover:bg-red-50 p-2 rounded"><Trash2 size={18}/></button>
                                </div>
                                ))} 
                        </div>
                        </div>
                            ...
                            {settings.products.map((prod, idx) => (
                                ...
                                <button onClick={() => handleRemoveFromArray('products', idx)} className="absolute top-2 right-2 text-red-500 hover:bg-red-50 p-1 rounded"><Trash2 size={18}/></button>
                                    ...
                                    <div className="flex gap-2">
                                        ...
                                        <button onClick={() => openMediaPicker((url) => handleArrayChange('products', idx, 'image', url))} className="bg-white px-3 py-2 border rounded text-sm"><Image size={16}/></button>
                                    </div>
                                </div>
                                ))} 
                        </div>
                            ...
                            {settings.impacts.map((imp, idx) => (
                                ...
                                <button onClick={() => handleRemoveFromArray('impacts', idx)} className="absolute top-2 right-2 text-red-500 hover:bg-red-50 p-1 rounded"><Trash2 size={18}/></button>
                                    <div className="flex gap-2">
                                        ...
                                        <button onClick={() => openMediaPicker((url) => handleArrayChange('impacts', idx, 'icon', url))} className="bg-white px-3 border rounded text-sm"><Image size={16}/></button>
                                    </div>
                            ...
                            {settings.applications.map((app, idx) => (
                                ...
                                <button onClick={() => handleRemoveFromArray('applications', idx)} className="absolute top-2 right-2 text-red-500 hover:bg-red-50 p-1 rounded"><Trash2 size={18}/></button>
                                    ...
                                    <div className="md:col-span-2 flex gap-2">
                                        ...
                                        <button onClick={() => openMediaPicker((url) => handleArrayChange('applications', idx, 'image', url))} className="bg-white px-3 border rounded text-sm"><Image size={16}/></button>
                                    </div>
                                </div>
                                ))} 
                        </div>
