    ...
    <section className=" md:mt-10 bg-white py-[40px]">
      <div className="max-w-[1440px] mx-auto px-4 sm:px-[40px] lg:px-[60px]">
        ...
        <div className="mb-8 lg:mb-12">
          <h2
            className="px-1 bg-[linear-gradient(269.91deg,#3CAADF_4.39%,#F04123_59.1%,#FFD212_113.8%)] bg-clip-text text-transparent inline-block text-[30px] sm:text-[36px] lg:text-[44px] font-bold italic leading-none"
