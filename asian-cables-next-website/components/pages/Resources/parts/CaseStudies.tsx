        ...
        <div className="mb-12 flex flex-col items-start justify-between gap-8 md:mb-16 md:flex-row md:items-end">
          ...
          <div>
            ...
            <p className="max-w-[640px] text-[16px] leading-[28px] text-[#525252]">
              Industry trends, technical articles, and expert opinions from our
              team
            </p>
          </div>
          {/* TABS */}
          <div className="flex flex-wrap gap-3">
            {tabs.map((tab) => (
              <button
                ...
                className={`h-[49px] min-w-[120px] rounded-[4px] px-5 text-[14px] font-medium transition-all duration-300 ${
                  activeTab === tab.id
              ...
              >
                ...
                <div className="flex min-h-[208px] w-[407px] flex-col justify-between px-8 py-3">
                  ...
                  <div className="mt-4 w-[330px] flex items-center justify-between">
                    ...
                    {/* ARROW */}
                    <button className="flex items-center justify-center text-[#1E3C8C] transition-all duration-300 group-hover:translate-x-1">
