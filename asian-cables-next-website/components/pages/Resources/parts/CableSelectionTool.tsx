...
export default function CableSelectionTool() {
  const topCards = [
    {
      title: "Cable Selection Tool",
      desc: "Identify the right cable for your application based on voltage, current, installation conditions, and performance requirements.",
      icon: "/assets/resources/calculator.png",
      bgImage: "/assets/resources/img-1.jpg",
      button: true,
    },
    {
      title: "D-Rating Tool",
