...
export default function IndustryFilter({ data }: { data?: any }) {
  ...
  return (
    <section className="relative z-20 w-full bg-white py-8">
      <div className="mx-auto flex px-5 md:px-0 w-[100%] max-w-[1274px] flex-col md:items-center gap-6  lg:items-center lg:justify-between">
        {/* LEFT REGION TABS */}
        <div className="flex md:my-4 m-auto justify-center rounded-[4px] bg-white gap-2 p-[6px] shadow-lg overflow-x-auto scrollbar-hide">
