    ...
    <section className="overflow-hidden bg-white py-16">
      <div className="mx-auto max-w-[1274px]">
        ...
        <div className="mb-10 md:px-0 px-5 flex md:flex-row flex-col md:items-center md:justify-between">
          <div>
                        <h2 className="font-[magistral]  text-[32px] leading-[100%] md:text-[46px] md:leading-[55.2px] tracking-[-0.92px] font-bold italic bg-[linear-gradient(269.91deg,#3CAADF_4.39%,#F04123_59.1%,#FFD212_113.8%)] bg-clip-text text-transparent inline-block">
             Leadership Team
</h2>
