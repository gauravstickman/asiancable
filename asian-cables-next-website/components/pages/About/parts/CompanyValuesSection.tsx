  ...
  return (
    <section className="bg-[#F8F9FB] py-6 md:py-16">
      <div className="mx-auto max-w-[1280px] px-4">
        <div className="mb-6">
          <h1 className="mb-4 font-[magistral] text-[32px] leading-[40px] md:text-[46px] md:leading-[42.17px] font-bold italic text-[#1E3C8C] text-center">
            Built on Precision. Driven by Purpose.
          </h1>
          <p className="font-[work_sans] text-[16px] leading-[24px] md:text-[19.77px] md:leading-[31.62px] font-normal text-[#525252] text-center">
        ...
        <div className="mb-4 grid grid-cols-12 gap-4">
          ...
          <div className="col-span-12 md:col-span-8">
            <div className="h-full rounded-[8px] bg-[#1E3C8C] p-8">
              ...
              <h2 className="block mb-3 text-[32px] md:text-[36px] text-[#ffffff] italic transition-colors duration-300 group-hover:text-white">
                  Our Vision
                </h2>
          ...
          <div className="col-span-12 md:col-span-4">
            <div className="group h-full rounded-[8px] border border-[#1E3C8C26] bg-white p-8 transition-all duration-300 hover:bg-[#1E3C8C] shadow-[0px_4px_12px_0px_#1E3C8C26]">
              <div className="mb-5 flex items-center gap-5">
                <img src="/assets/about/targetIcon.png" className="resource-img " alt="Purpose Icon" />
          ...
          <div className="col-span-12 md:col-span-6">
            <div className="group  h-full rounded-[8px] border border-[#1E3C8C26] bg-white p-8 transition-all duration-300 hover:text-white hover:bg-[#1E3C8C] shadow-[0px_4px_12px_0px_#1E3C8C26]">
              <div className="mb-5 flex items-center gap-8">
                <img src="/assets/about/targetIcon.png" alt="Purpose Icon" className="resource-img " />
                <h2 className="text-[32px] md:text-[36px] font-black text-[#1E3C8C] italic transition-colors duration-300 group-hover:text-white">
                  Our Purpose
                </h2>
              </div>
