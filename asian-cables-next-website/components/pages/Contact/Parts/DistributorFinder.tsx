  ...
  return (
    <section className="bg-[#FFFFFF] pb-[40px] md:pb-[80px] md:pt-[80px]" id="FindDisributers">
      <div className="mx-auto max-w-[1280px] px-5">
        {/* Heading */}
        <h2 className="font-[magistral] text-[32px] leading-[100%] md:text-[46px] md:leading-[55.2px] md:tracking-[-0.92px] italic font-bold px-1 bg-[linear-gradient(269.91deg,#3CAADF_4.39%,#F04123_59.1%,#FFD212_113.8%)] bg-clip-text text-transparent inline-block">
