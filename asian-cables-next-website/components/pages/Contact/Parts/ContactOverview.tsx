      ...
      <div className="mx-auto max-w-[1280px] px-5">
        <div className="grid gap-[40px] lg:grid-cols-[1fr_552px]">
          ...
          <div className="max-w-[665px]">
            ...
            {/* Heading */}
            <h1 className="font-[magistral] text-[36px] leading-[140%] tracking-[5%] md:text-[72px] italic font-bold md:leading-[64px] md:tracking-[-3.6px] px-1 bg-[linear-gradient(269.91deg,#3CAADF_4.39%,#F04123_59.1%,#FFD212_113.8%)] bg-clip-text text-transparent inline-block">
