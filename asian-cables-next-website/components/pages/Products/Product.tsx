              ...
              <div className="mb-10 grid grid-cols-2 gap-y-8">
                ...
                <div className="flex items-center items-start gap-3">
                  <div className="flex h-8 w-8 shrink-0 items-center justify-center">
                    <img src="/assets/p-1.svg" alt="" className="w-8" />
                  </div>
                ...
                <div className="flex items-center items-start gap-3">
                  <div className="flex h-8 w-8 shrink-0 items-center justify-center">
                    <img src="/assets/p-2.svg" alt="" className="w-8" />
                  </div>
                ...
                <div className="flex items-center items-start gap-3">
                  <div className="flex h-8 w-8 shrink-0 items-center justify-center">
                    <img src="/assets/p-3.svg" alt="" className="w-8" />
                  </div>
                ...
                <div className="flex items-center items-start gap-3">
                  <div className="flex h-8 w-8 shrink-0 items-center justify-center">
                    <img src="/assets/p-4.svg" alt="" className="w-8" />
                  </div>
          ...
          <div className="mb-10 grid grid-cols-1 items-center gap-16 lg:grid-cols-2">
            ...
            <div>
              ...
              <p className="mb-8 text-[18px] leading-[1.9] text-[#6F6F6F]">
                Asian Cables Instrumentation cables are designed for accurate
                signal transmission in industrial control and monitoring
                systems. These cables feature high-quality copper conductors,
                advanced insulation materials and shielding options to minimize
                signal interference. Ideal for industries where precise data and
                signal transmission are critical for operational reliability.
              </p>
              ...
              <div className="relative h-[190px] w-[50%] overflow-hidden rounded-[6px] bg-white p-6 md:h-[250px] md:w-[100%] md:p-10">
                ...
                <div className="relative z-10">
                  ...
                  <div className="space-y-4 md:space-y-6">
                    {["IEC Standards", "BS Standards", "IS Standards"].map(
                      (item, index) => (
