...
export default function FloatingActions() {
  ...
  return (
    <>
      {/* FLOATING BAR */}
   <div
  className={`fixed left-0 right-0 md:right-auto m-auto w-[97%] md:w-[auto] md:left-1/2 bottom-6 z-[999999] md:-translate-x-1/2 transition-all duration-500 ${
    show && !hideAtFooter
      ? "translate-y-0 opacity-100"
      : "translate-y-[120px] opacity-0 pointer-events-none"
  }`}
>
  <div className="flex overflow-visible rounded-md border border-blue-200 bg-white shadow-2xl justify-end">

    {/* COMPANY */}
    <button className="flex items-center gap-1 md:gap-2 border-r px-2 py-3 md:px-6 md:py-4 text-[11px] leading-[1.2] md:text-sm font-medium text-blue-900 hover:bg-blue-50">
      <FileText size={18} />
      Company Overview
    </button>
    ...
    <div className="relative">
      ...
      <button
        ...
        className="flex download-btn items-center gap-1 md:gap-2 bg-[#1f4aa8] px-2 py-3 md:px-6 md:py-4 text-[11px] leading-[1.2] md:text-sm text-white hover:bg-[#173983]"
      >
        <Download size={18} />
        Downloads
      </button>
