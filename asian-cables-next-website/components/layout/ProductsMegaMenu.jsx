...
export default function ProductsMegaMenu({ industryGroups = {}, typeGroups = {} }) {
  ...
  return (
    <>
            ...
            <div className="col-span-3">
              ...
              <div className="flex flex-col gap-[15px]">
                ...
                <button
                  ...
                  className={`flex items-center justify-between rounded-md px-6 py-5 text-left text-[21.02px] leading-[106%] italic font-[700] transition ${activeTab === "industry"
                ...
                >
                  <span className="flex items-center gap-2">
                    <bdi><img
                      ...
                      className={`w-[23px] h-[23px] object-contain transition ${activeTab === "industry"
                          ? "brightness-0"
                          : "brightness-[0.4]"
                        }`}
                ...
                <button
                  ...
                  className={`flex items-center justify-between rounded-md px-6 py-5 text-left text-[21.02px] leading-[106%] italic font-[700] transition ${activeTab === "type"
                      ? "bg-[#F5F5F5] text-[#21409A]"
                      : "text-[#9AA4C0]"
                    }`}
                >
                  <span className="flex items-center gap-2">
                    <bdi><img
                      src="/assets/menu-cable.svg"
                      className={`w-[23px] h-[23px] object-contain transition ${activeTab === "type"
                          ? "brightness-0"
                          : "brightness-[0.4]"
                        }`}
                    /></bdi> Cables by Type
      ...
      <img src="/assets/menu-prop.png" className="absolute right-0 bottom-0 w-[150px]" />
